...
public class CalendarController {
    ...
    @Operation(
            ...
            description = "특정 날짜의 상세 정보를 조회합니다.\n\n" +
                    ...
                    "- `schedules`: 해당 날짜에 확정된 일정 목록 (시간 순으로 정렬)\n" +
                    "  - 각 일정의 정보: 제목, 장소, 일정 시간, D-Day\n\n" +
                    "**주의사항**:\n" +
                    "- 프론트엔드에서 하루당 최대 3개 일정만 표시하도록 처리해야 합니다.\n" +
                    "- 백엔드는 해당 날짜의 모든 일정을 반환하며, 프론트에서 3개로 제한하여 모달에 표시합니다.\n\n" +
                    "**사용 예시**:\n" +
                    "- 달력에서 날짜를 클릭했을 때 모달로 일정 상세 정보 표시\n" +
                    "- 해당 날짜의 확정된 일정 목록 확인"
    )
    @ApiResponses({
